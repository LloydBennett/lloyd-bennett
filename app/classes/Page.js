  ...
  defaultTransition(state, resolve, { start, middle, end }) {
    ...
    switch (state) {
      case 'show':
        ...
        this.tl.fromTo(this.elements.heroImgContainer, { clipPath: "polygon(0% 100%, 100% 100%, 100% 100%, 0% 100%)" }, { clipPath: "polygon(0% 100%, 100% 100%, 100% 0%, 0% 0%)", duration: 0.8, stagger: { amount: 0.4 }, ease: "power2.out" }, "-=0.5")

        this.tl.fromTo(this.elements.heroImage, { scale: 1.5 }, { scale: 1, duration: 0.8, stagger: { amount: 0.4 }, ease: "power2.out" }, "-=0.8")
